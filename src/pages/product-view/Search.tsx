...
export default function Search({searchTerm,handleSearchChange}: props) {
  return (
    <div className="flex justify-between items-end bg-secondary pb-2 pt-[4%] px-[5%]">
      <h1 className=" text-2xl md:text-5xl text-primary font-bold">Productos</h1>
